...
#### Load packages ####
if(!require('gridExtra')) install.packages('gridExtra') # data wrangling
library('gridExtra')
...
png(filename="Figures/FIG.MTL01.png", width=16, height=9, units="cm", res=600)
plot(FIG.MTL01)
dev.off()
...
png(filename="Figures/FIG.MTL02.png", width=16, height=9, units="cm", res=600)
plot(FIG.MTL02)
dev.off()
...
png(filename="Figures/FIG.BOARD1.png", width=15, height=7.5, units="cm", res=300)
plot(FIG.BOARD1)
dev.off()
...
FIG.COR01 <- ggcorrplot(test.COR01, hc.order=T, lab=T, method="square",
...
png(filename = "Figures/FIG.COR01.png", width=32, height=18, units="cm", res=600)
plot(FIG.COR01)
dev.off()

FIG.COR02 <- ggcorrplot(test.COR02, hc.order=T, lab=T, method="square",
                        outline.col="white", type="lower",
                        ggtheme=ggplot2::theme(axis.title=element_text(size=12, 
                                                                       face="bold", 
                                                                       color="#2D2424"),
...
png(filename="Figures/FIG.COR02.png", width=32, height=18, units="cm", res=600)
plot(FIG.COR02)
dev.off()
...
# M1
summary(M1)
FIG.M1 <- ggplot(data=data.PLOT1, aes(x=CVRG, y=PROD))+
  geom_point(size=3, alpha=0.75, color="#91091E")+
  geom_smooth(method=lm, linetype=2, color="#493323", alpha=0.125,
              fill="#493323")+
  labs(x="Forest cover percentage", y="Coffee production (kg ha^-1)")+
  ylim(0, 3500)+
  theme(axis.title=element_text(size=12, face="bold", color="#493323"),
        axis.text=element_text(size=10, color="#493323"),
        axis.line=element_line(colour="#493323"),
        ...
        panel.grid=element_blank(),
        panel.background=element_rect(fill="#F4EEED", color="#F4EEED"))+
  annotate(size=2.5, "text", x=24.8415, y=3250, label="Y = 1413.70 + 19.90 * X | t = 1.963, p = 0.062 .",
           color="#493323")
FIG.M1

png(filename="Figures/FIG.M1.png", width=15, height=7.5, units="cm", res=300)
plot(FIG.M1)
dev.off() 
...
FIG.M2 <- ggplot(data=data.PLOT1, aes(x=DNST, y=PROD))+
  ...
  geom_smooth(method=lm, linetype=1, color="#493323", alpha=0.125,
              fill="#493323")+
  labs(x="Forest patches density", y="Coffee production (kg ha^-1)")+
  ylim(0, 3500)+
  theme(axis.title=element_text(size=12, face="bold", color="#493323"),
        axis.text=element_text(size=10, color="#493323"),
        axis.line=element_line(colour="#493323"),
...
png(filename="Figures/FIG.M2.png", width=32, height=18, units="cm", res=600)
plot(FIG.M2)
dev.off()
...
FIG.M3 <- ggplot(data=data.PLOT1, aes(x=ISLT, y=PROD))+
  ...
  geom_smooth(method=lm, linetype=1, color="#493323", alpha=0.125,
              fill="#493323")+
  labs(x="Forest patches isolation", y="Coffee production (kg ha^-1)")+
  ylim(0, 3500)+
  theme(axis.title=element_text(size=12, face="bold", color="#493323"),
        axis.text=element_text(size=10, color="#493323"),
        axis.line=element_line(colour="#493323"),
...
png(filename="Figures/FIG.M3.png", width=32, height=18, units="cm", res=600)
plot(FIG.M3)
dev.off()
...
png(filename="Figures/FIG.M4.png", width=32, height=18, units="cm", res=600)
plot(FIG.M4)
dev.off()
...
FIG.M5 <- ggplot(data=data.PLOT1, aes(x=CNNC, y=PROD))+
  ...
  geom_smooth(method=lm, linetype=2, color="#493323", alpha=0.125,
              fill="#493323")+
  labs(x="Forest patches connectance", y="Coffee production (kg ha^-1)")+
  ylim(0, 3500)+
  theme(axis.title=element_text(size=12, face="bold", color="#493323"),
        axis.text=element_text(size=10, color="#493323"),
        axis.line=element_line(colour="#493323"),
...
png(filename="Figures/FIG.M5.png", width=32, height=18, units="cm", res=600)
plot(FIG.M5)
dev.off()
...
png(filename="Figures/FIG.M6.png", width=32, height=18, units="cm", res=600)
plot(Fig.M6)
dev.off()
...
png(filename="Figures/FIG.M7.png", width=32, height=18, units="cm", res=600)
plot(FIG.M7)
dev.off()
...
png(filename="FIG.Delta.png", width=16, height=9, units="cm", res=600)
plot(Fig.Delta)
dev.off() 
...
png(filename="Figures/FIG.BOARD2.png", width=15, height=15, units="cm", res=300)
plot(Fig.Board2)
dev.off()
...
png(filename="Figures/FIG.BOARD3.png", width=15, height=15, units="cm", res=300)
plot(Fig.Board3)
dev.off()
...
png(filename="FIG10.png", width=9, height=9, units="cm", res=600)
plot(FIG10)
dev.off()